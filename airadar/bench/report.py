...
def _git_dirty():
    # --untracked-files=no намеренно: вопрос в том, отличается ли ОТСЛЕЖИВАЕМЫЙ
    # код от коммита. Посторонние логи и промежуточные чекпоинты рядом в дереве
    # на воспроизводимость прогона не влияют.
