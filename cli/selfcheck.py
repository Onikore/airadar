...
# выглядеть успешным. На 2026-07-28 модулей с логикой тридцать — девять в
# bench/, пять в data/, два в diag/, четыре в features/, четыре в models/,
# пять в augment/, один в train/, один airadar/config.py.
#
